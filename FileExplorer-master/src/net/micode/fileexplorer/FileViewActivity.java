...
public class FileViewActivity extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ActivitiesManager.getInstance().registerActivity(
				ActivitiesManager.ACTIVITY_FILE_VIEW, mActivity);// 加入活动管理器队列中

		mFileCagetoryHelper = new FileCategoryHelper(mActivity);// 分类文件管理帮助类
		mFileViewInteractionHub = new FileViewInteractionHub(this);// 文件视图交互类
		...
		if (!TextUtils.isEmpty(action)
			...
			/**
			 * Intent.ACTION_GET_CONTENT： Display the list of people's phone
			 * numbers, allowing the user to browse through them and pick one
			 * and return it to the parent activity. Intent.ACTION_PICK:Activity
